...
def report() -> str:
    ...
    out.append("")
    out.append("PRESS SCALLOP - NOT CUT YET")
    out.append("  The press is stashed for the prototype. Leave the rim whole.")
    out.append("  When it comes back it wants a scallop cut IN FROM THE RIM at")
    out.append("  its stop angle, oversize and fitted to the real machine - the")
    out.append("  ram-axis depth is still unmeasured. Cutting it now would be")
    out.append("  removing wood to fit a number nobody has.")
    out.append("")
